...
export const database_management_systems: string[] = [
  "Aerospike (database)",
  "Altibase",
  "Apache Accumulo",
  "Apache Cassandra",
...
export const server_side_frameworks: string[] = [
...
export const javascript_frameworks: string[] = [
"Angular",
"AngularJS",
"Apache Royale",
"Backbone.js",
